...
# Load data
eth_df = load_data("/Users/brocktbennett/GitHub/Project Data/mini_project/Untitled spreadsheet - ETH.csv")

# Display initial data details
display_data_details(eth_df)
...
eth_df['Snapshotdatetime'] = pd.to_datetime(eth_df['Snapshotdatetime'])
eth_df['Days'] = (eth_df['Snapshotdatetime'] - eth_df['Snapshotdatetime'].min()).dt.days
